  ...
  Widget build(BuildContext context) {
    return const Column(
      children: [
        Row(
          children: [
            MouseButton(icon: Icons.arrow_left, buttonType: ButtonType.Left),
            SizedBox(width: 10),
            MouseButton(icon: Icons.arrow_right, buttonType: ButtonType.Right),
          ],
        ),
        SizedBox(height: 10),
        Row(
          children: [
            MouseButton(icon: Icons.skip_previous, buttonType: ButtonType.Back),
            SizedBox(width: 10),
            MouseButton(icon: Icons.unfold_more, buttonType: ButtonType.Middle),
            SizedBox(width: 10),
            MouseButton(icon: Icons.skip_next, buttonType: ButtonType.Forward),
          ],
        ),
      ],
    );
...
class MouseButton extends StatelessWidget {
  ...
  const MouseButton({super.key, required this.icon, required this.buttonType});
